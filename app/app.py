...
if menu_collection.count_documents({}) == 0:
    menu_collection.insert_many([
        ...
        {'item_id': 'croissant', 'name': 'Croissant', 'description': 'Decadent and Flakey. Perfect piece of bread.', 'price': 2, 'category': 'Bread'},
        {'item_id': 'focaccia', 'name': 'Focaccia', 'description': 'Oven baked Italian flat bread. Very Tasty!.', 'price': 3, 'category': 'Bread'},
        {'item_id': 'sourdough', 'name': 'Sourdough', 'description': "Tangy and delicious loaf that you'll love",  'price': 4, 'category': 'Bread'},
        {'item_id': 'whole_grain', 'name': 'Whole Grain', 'description': "Tangy and delicious loaf that you'll love",  'price': 5, 'category': 'Bread'},
        {'item_id': 'almond_cookie', 'name': 'Almond Cookie', 'description': "Delicious cookie topped with Almonds", 'price': 6, 'category': 'Cookie'},
        {'item_id': 'chocolate_cookie', 'name': 'Chocolate Cookie', 'description': "Rich and flavorful cookie for your chocolate cravings", 'price': 7, 'category': 'Cookie'},
        {'item_id': 'chocolate_chip_cookie', 'name': 'Chocolate Chip Cookie', 'description': "Our take on the classic simple cookie!", 'price': 8, 'category': 'Cookie'},
        ...
        {'item_id': 'chocolate_berry_cake', 'name': 'Chocolate Berry Cake', 'description': "Moist Chocolate cake topped with Mixed Berries!", 'price': 16, 'category': 'Cake'},
        {'item_id': 'chocolate_mousse_cake', 'name': 'Chocolate Mousse Cake',  'description': "Enjoy a cake with fluffy chocolate mousse", 'price': 17, 'category': 'Cake'},
        {'item_id': 'rainbow_cake', 'name': 'Rainbow Cake', 'description': "Seven layer cake of colorful and delicious ingredients!", 'price': 18, 'category': 'Cake'},
        {'item_id': 'red_velvet', 'name': 'Red Velvet',  'description': "Cake with a rich red color and cream cheese frosting", 'price': 19, 'category': 'Cake'},
        {'item_id': 'strawberry_shortcake', 'name': 'Strawberry Shortcake',  'description': "Vanilla cake with frosting and fresh strawberries", 'price': 20, 'category': 'Cake'},
